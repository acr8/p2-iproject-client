  ...
  <div class="w-full flex flex-wrap">
        ...
        <div class="w-1/2 shadow-2xl">
          <img class="object-cover w-full h-screen hidden md:block"
            src="https://images.unsplash.com/photo-1581067721837-e4809b29692d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2080&q=80">
        </div>
    ...
    <div class="w-full md:w-1/2 flex flex-col" style="background-color: #ffffff;">
      ...
      <div
        class="flex justify-center md:justify-start pt-1 md:pl-12 md:-mb-24 absolute right-56 hover:scale-105 transition duration-700 ease-in-out cursor-pointer">
        <img
          src="https://cdn.discordapp.com/attachments/414438038358196234/935229824455282808/Get_Market-logos_main.png"
          width="580px">
      </div>

      <div class="flex flex-col justify-center md:justify-start my-auto pt-1 md:pt-24 px-8 md:px-24 lg:px-32">
        <p class="text-left text-4xl font-bold text-gray-700 pb-2">Welcome!</p>
        <p class="text-left text-xl text-gray-700">Register here!</p>

        <form @submit.prevent="formRegister" class="flex flex-col pt-3 md:pt-6">
          
          <div class="flex flex-col">
            <label class="text-xl font-bold mb-1" style="color: rgb(255, 38, 0);">Username</label>
          ...
          <div class="flex flex-col pt-4">
            <label class="text-xl font-bold mb-1" style="color: rgb(255, 38, 0);">Email</label>
        ...
        <div class="text-center pt-10 pb-6">
          <p>Already have an account? <span @click="toLogin" class="underline font-semibold cursor-pointer hover:text-red-700">Login here.</span></p>
        </div>
...
export default {
  ...
  components: {
    ...
    return {
      ...
      params: {
        client_id:
          "199910436713-vf3a8iki4hadh9e1i1ghro1omj65jboh.apps.googleusercontent.com",
      },
    };
  },
  
  computed: {
    ...mapState(["isRegisterPage"])
  },
  methods: {
    toLogin() {
    ...
    async formRegister() {
      await this.$store.dispatch("doRegister", this.userData);
